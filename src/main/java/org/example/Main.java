...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Enter Product ID to verify: ");
        String supplierProductId = scanner.nextLine();
        if (!supplierProductId.equals(productId)) {
            System.out.println("Error: Product ID does not match the Manufacturer's Product ID.");
        } else {
